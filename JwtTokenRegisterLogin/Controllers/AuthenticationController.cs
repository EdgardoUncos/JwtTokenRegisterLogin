using JwtTokenRegisterLogin.Auth;
using JwtTokenRegisterLogin.Configuration;
using JwtTokenRegisterLogin.DTOs;
...
namespace JwtTokenRegisterLogin.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserRegistrationRequestDto request)
        {
            ...
            // Verificar si el email existe en la tabla creada
            ...
            {
                Result = false,
                Errors = new List<string> { "El usuario no pudo ser encontrado" }
            });
        }
        ...
        public async Task<IActionResult> Login([FromBody] UserLoginRequestDto request)
        {
            ...
            // chequear el usuario y contraseña
